...
% Accuracy
\markdownInput[slice=accuracy ^accuracy-representations,
               snippet=horizontalRule/singleFrame]{defense.md}
\markdownInput[slice=accuracy-representations]{defense.md}
\markdownInput[slice=accuracy-learning-to-rank]{defense.md}
\markdownInput[slice=accuracy-approximate-search]{defense.md}

% Speed
\markdownInput[slice=speed ^speed-deployment,
               snippet=horizontalRule/singleFrame]{defense.md}
\markdownInput[slice=speed-deployment]{defense.md}
\markdownInput[slice=speed-representations]{defense.md}
\markdownInput[slice=speed-approximate-search]{defense.md}

% Interpretability
\markdownInput[slice=interpretability ^interpretability-representations,
               snippet=horizontalRule/singleFrame]{defense.md}
\markdownInput[slice=interpretability-representations]{defense.md}
\markdownInput[slice=interpretability-strengths-and-weaknesses]{defense.md}
\markdownInput[slice=interpretability-interactive-visualizations]{defense.md}
...
\begin{frame}[fragile, allowframebreaks]{\secname}
  \markdownInput[slice=accuracy-representations,
                 snippet=horizontalRule/frameBreak]{defense.md}
\end{frame}

\subsection{Learning to Rank}
\begin{frame}[fragile, allowframebreaks]{\secname}
  \markdownInput[slice=accuracy-learning-to-rank,
                 snippet=horizontalRule/frameBreak]{defense.md}
\end{frame}

\subsection{Approximate Nearest-Neigbor Search}
\begin{frame}[fragile, allowframebreaks]{\secname}
  \markdownInput[slice=accuracy-approximate-search,
                 snippet=horizontalRule/frameBreak]{defense.md}
\end{frame}

\section{Speed}

\subsection{Search Engine Deployment}
\begin{frame}[fragile]{\secname}
  \markdownInput[slice=speed-deployment]{defense.md}
\end{frame}
...
\begin{frame}[fragile, allowframebreaks]{\secname}
  \markdownInput[slice=speed-representations,
                 snippet=horizontalRule/frameBreak]{defense.md}
\end{frame}

\subsection{Approximate Nearest-Neigbor Search}
\begin{frame}[fragile, allowframebreaks]{\secname}
  \markdownInput[slice=speed-approximate-search,
                 snippet=horizontalRule/frameBreak]{defense.md}
\end{frame}
...
\begin{frame}[fragile, allowframebreaks]{\secname}
  \markdownInput[slice=interpretability-strengths-and-weaknesses,
                 snippet=horizontalRule/frameBreak]{defense.md}
\end{frame}

\subsection{Interactive Visualizations of Retrieval Collections}
\begin{frame}[fragile, allowframebreaks]{\secname}
  \markdownInput[slice=interpretability-interactive-visualizations,
                 snippet=horizontalRule/frameBreak]{defense.md}
\end{frame}

\section{Conclusion}
\begin{frame}[fragile, allowframebreaks]
  \markdownInput[slice=conclusion,
                 snippet=horizontalRule/frameBreak]{defense.md}
\end{frame}

\section{List of Author's Publications}
\begin{frame}[fragile, allowframebreaks]
  \markdownInput[slice=list-of-publications,
                 snippet=horizontalRule/frameBreak]{defense.md}
\end{frame}
