...
\markdownInput[slice=oard ^soft-cosine-measure-questions, snippet=horizontalRule/singleFrame]{defense.md}
...
\markdownInput[slice=skopal ^defense-questions, snippet=horizontalRule/singleFrame]{defense.md}
...
\begin{frame}[fragile, allowframebreaks]{\secname}
  \markdownInput[slice=soft-cosine-measure-questions, snippet=horizontalRule/frameBreak]{defense.md}
\end{frame}

\subsection{Sentence-BERT Questions}
\begin{frame}[fragile, allowframebreaks]{\secname}
  \markdownInput[slice=sentence-bert-questions, snippet=horizontalRule/frameBreak]{defense.md}
\end{frame}

\subsection{System Combination Questions}
\begin{frame}[fragile, allowframebreaks]{\secname}
  \markdownInput[slice=system-combination-questions, snippet=horizontalRule/frameBreak]{defense.md}
\end{frame}

\subsection{Interpretable Representation Questions}
\begin{frame}[fragile, allowframebreaks]{\secname}
  \markdownInput[slice=interpretable-representation-questions, snippet=horizontalRule/frameBreak]{defense.md}
\end{frame}
...
\begin{frame}[fragile, allowframebreaks]{\secname}
  \markdownInput[slice=defense-questions, snippet=horizontalRule/frameBreak]{defense.md}
\end{frame}
